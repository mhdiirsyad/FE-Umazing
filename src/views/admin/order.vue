<template>
  <div>
    ...
    <div class="flex flex-col-reverse gap-2 items-start lg:justify-between lg:flex-row py-4">
      <input type="text">
      <!-- Modal toggle -->
      <button data-modal-target="crud-modal" data-modal-toggle="crud-modal" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium sm:font-normal rounded-lg text-sm px-5 py-2.5 text-center" type="button">
        Add Category
      </button>
    </div>
...
const { categories } = storeToRefs(useCategory);
