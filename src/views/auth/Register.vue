  ...
  <div class="flex flex-col lg:flex-row justify-center items-center w-full gap-8 mt-10">
    ...
    <div
      ...
      <form class="space-y-6" @submit.prevent="handleRegister(form)">
        ...
        <button type="submit"
          class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Sign in
